 ...
 * @author Salvatore
 */
public class UpdateTipoDocumento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String nuovoTipoDocumento = request.getParameter("tipoDocumento");
        ...
        try {
            ...
            Tipologia_documento tipoDocumento = em.find(Tipologia_documento.class, Long.parseLong(nuovoTipoDocumento));
