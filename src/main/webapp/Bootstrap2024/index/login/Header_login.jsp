            ...
            <div class="row">
                <div class="col-12">
                    <div class="it-header-slim-wrapper-content">
                        <a class="d-lg-block navbar-brand" href="#">titolo webapp</a>
                            ...
                            <div class="it-brand-wrapper">
                                <a href="/bootstrap-italia/docs/esempi/comuni/template-homepage/">
                                    ...
                                    <div class="it-brand-text">
                                        <div class="it-brand-title"><h3 class="kt-login__title kt-font-io" style="font-size:2rem; color:white !important;"><b>YES I STARTUP - EntryDoc</b></h3></div>
