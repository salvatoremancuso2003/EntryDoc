<%-- 
    Document   : 500_
    Created on : 26 feb 2024, 15:56:36
    Author     : Aldo
--%>
                ...
                <div class="d-flex flex-column flex-center text-center p-10">
                    ...
                    <div class="card card-flush w-lg-650px py-5">
                        <div class="card-body py-15 py-lg-20">
                            <!--begin::Title-->
                            <h1 class="fw-bolder fs-2qx text-gray-900 mb-4">Errore di sistema</h1>
                            <!--end::Title-->
                            <!--begin::Text-->
                            <div class="fw-semibold fs-6 text-gray-500 mb-7">Qualcosa è andato storto! Perfavore riprova piu tardi.</div>
                            <!--end::Text-->
                            <!--begin::Illustration-->
                            <div class="mb-11">
